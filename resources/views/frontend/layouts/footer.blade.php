                ...
                <div class="col-sm-12 col-md-12 col-lg-3">
                    <div class="footer-widget-contact">
                        ...
                        <ul class="contact-list list-unstyled">
                            <li>
                                <a
                                    href="https://7oroof.com/cdn-cgi/l/email-protection#fd8d8f928b9889899cbdca928f92929bd39e9290">
                                    <i class="contact-icon icon-email"></i> <span><span class="__cf_email__"
                                            data-cfemail="e9999b869f8c9d9d88a9de869b86868fc78a8684">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li>
                ...
                <div class="col-12 d-flex flex-wrap">
                    <ul class="social-icons list-unstyled mb-0 mr-50">
                        ...
                        <div class="m-0 d-flex align-items-center">
                            <span>&copy; 2024 BioMac Lab, All Rights Reserved. With Love by</span>
                            <a class="color-secondary" href="https://www.codershatbd.com/"> &nbsp;Coder's Hat</a>
                        </div>
                </div>
            </div>
        </div>
