<x-admin-app-layout :title="'Researcher Update'">
    <div class="card card-flash">
        <div class="card-body scroll-y mx-5 mx-xl-15 my-7">
            <form class="form" method="POST" action="{{ route('admin.researcher.update', $researcher->id) }}"
                ...
                <div class="row">
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="name" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="name" :value="old('name', $researcher->name)" placeholder="Enter Full Name"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="email" type="email" class="form-control-solid mb-3 mb-lg-0"
                            name="email" :value="old('email', $researcher->email)" placeholder="example@domain.com"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="phone" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="phone" :value="old('phone', $researcher->phone)" placeholder="Enter Phone Number"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="designation" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="designation" :value="old('designation', $researcher->designation)" placeholder="Enter Designation"></x-metronic.input>
                    </div>

                    <div class="col-lg-4 mb-7">
                        <x-metronic.label for="image"
                            class="fw-bold fs-6 mb-2">{{ __('Photo') }}</x-metronic.label>
                        <x-metronic.file-input id="image" class="form-control-solid mb-3 mb-lg-0" :source="asset('storage/' . $researcher->image)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="linked_in" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="linked_in" :value="old('linked_in', $researcher->linked_in)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="instagram" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="instagram" :value="old('instagram', $researcher->instagram)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="facebook" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="facebook" :value="old('facebook', $researcher->facebook)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="youtube" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="youtube" :value="old('youtube', $researcher->youtube)" placeholder="Enter YouTube Channel URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="tiktok" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="tiktok" :value="old('tiktok', $researcher->tiktok)" placeholder="Enter TikTok Profile URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="github" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="github" :value="old('github', $researcher->github)" placeholder="Enter GitHub Profile URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="website" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="website" :value="old('website', $researcher->website)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="discord" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="discord" :value="old('discord', $researcher->discord)" placeholder="Enter Discord Username"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="portfolio" type="url" class="form-control-solid mb-3 mb-lg-0"
                            name="portfolio" :value="old('portfolio', $researcher->portfolio)" placeholder="Enter Portfolio URL"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.textarea id="biography" class="form-control-solid mb-3 mb-lg-0" name="biography"
                            placeholder="Enter Biography">{{ old('biography', $researcher->biography) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="location" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="location" :value="old('location', $researcher->location)" placeholder="Enter Location"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="start_date" type="date" class="form-control-solid mb-3 mb-lg-0"
                            name="start_date" :value="old('start_date', $researcher->start_date)"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <select class="form-select" name="status" data-control="select2" data-hide-search="true"
                            ...
                            <option value="active"
                                {{ old('status', $researcher->status) == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="on_leave"
                                {{ old('status', $researcher->status) == 'on_leave' ? 'selected' : '' }}>On Leave
                            </option>
                            <option value="inactive"
                                {{ old('status', $researcher->status) == 'inactive' ? 'selected' : '' }}>Inactive
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="language" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="language" :value="old('language', $researcher->language)" placeholder="List Languages Spoken"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="order" type="number" class="form-control-solid mb-3 mb-lg-0"
                            name="order" :value="old('order', $researcher->order)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="skills" class="form-control-solid mb-3 mb-lg-0" name="skills"
                            placeholder="List Skills (comma separated)">{{ old('skills', $researcher->skills) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="awards" class="form-control-solid mb-3 mb-lg-0" name="awards"
                            placeholder="List Awards or Recognition">{{ old('awards', $researcher->awards) }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.textarea id="interests" class="form-control-solid mb-3 mb-lg-0" name="interests"
                            placeholder="List Interests or Hobbies">{{ old('interests', $researcher->interests) }}</x-metronic.textarea>
                    </div>
                </div>
