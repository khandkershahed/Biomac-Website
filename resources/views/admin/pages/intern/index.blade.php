<x-admin-app-layout :title="'Interns List'">
    <div class="card">
        <div class="card-header bg-info d-flex justify-content-between align-items-center">
            <h1 class="mb-0 text-white">Manage Your Interns</h1>
            <a href="{{ route('admin.intern.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <span class="pt-2">Add Intern</span>
            </a>
        </div>
