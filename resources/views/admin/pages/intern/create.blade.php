 <x-admin-app-layout :title="'Intern Add'">
    <div class="card card-flash">
        <div class="card-body scroll-y mx-5 mx-xl-15 my-7">
            <form class="form" method="POST" action="{{ route('admin.intern.store') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="researchgate" type="text" class="form-control-solid mb-3 mb-lg-0"
                            name="researchgate" :value="old('researchgate')" placeholder="Enter Research Gate"></x-metronic.input>
                    </div>
